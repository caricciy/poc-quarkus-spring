...
// Output port for fetching routers from the data source
// The role of output port is describe, in a technology-agnostic way,
...
// relational database technology or filesystem for exemple.
